...
if __name__ == "__main__":
    ...
    command = 'test_1'
    test_workspace_2_1 = wc.workspace()
    test_workspace_2_1.set_attribute('commands', command)
    commands = ['test_2.1', 'test_2.2']
    test_workspace_2_1.set_attribute('commands', commands)

    attributes = test_workspace_2_1.get_attributes()
    print(attributes)
